#!/usr/bin/env python3
"""Conector local do SAM para o Epiaka.

Use somente checkpoints baixados da fonte oficial da Meta. Exemplo:
python epiaka-sam-local.py --checkpoint sam_vit_b_01ec64.pth --model-type vit_b
"""
...
app = FastAPI(title="Epiaka SAM local", version="1.0")
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],
...
def main():
    ...
    print(f"Epiaka SAM pronto em http://127.0.0.1:{args.port}")
