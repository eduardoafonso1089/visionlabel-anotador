...
export const metadata:Metadata={title:"VisionLabel — Anotação de Imagens",description:"Anote imagens para treinar modelos de visão computacional e exporte em COCO ou YOLO.",other:{"codex-preview":"development"},icons:{icon:"/favicon.svg"}};
